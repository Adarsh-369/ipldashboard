...
class TeamMatches extends Component {
    ...
    getTeamMatches = async () => {
        ...
        const updatedData = {
            ...
            latestMatchDetails: {
                ...
                competingTeamLogo: fetchedData.latest_match_details.competing_team,
                ...
                secondInnings: fetchedData.latest_match-details.second_innings,
    ...
    renderTeamMatches = () => {
        ...
        const {teamBannerUrl, latestMatchesDetails} = matchesData 
        return (
